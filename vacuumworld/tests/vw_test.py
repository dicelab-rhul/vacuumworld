...
def test_agent_placed_properly() -> None: # whenever agent is placed Is  it placed properly
    grid: Grid = Grid(5)
    agent1: Agent = grid.agent('green','north')
...
def test_agent_removed_properly() -> None:
    grid: Grid = Grid(4)
    agent1: Agent = grid.agent('orange','north')
...
def test_agent_move_properly() -> None:
    grid: Grid = Grid(4)
    agent1: Agent = grid.agent('orange','east')
