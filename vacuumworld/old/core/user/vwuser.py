...
class User():
    ...
    def revise(self, observation: Observation, messages: Iterable):
        self.id: str = observation.center.actor.name
    ...
    def is_agent_ahead(self) -> bool:
        return self.observation.forward and self.observation.forward.actor

    def is_agent_on_the_left(self) -> bool:
        return self.observation.left and self.observation.left.actor

    def is_agent_of_the_right(self) -> bool:
        return self.observation.right and self.observation.right.actor
